...
const sendEmailConfirmation = ({ email, fullName, confirmationToken }) => {
    try {
        ...
        const mailOptions = {
            to: email,
            subject: "Kantin Online Email Confirmation",
            html: `
            <div style="font-family: Arial, sans-serif; background-color: #f1f1f1; padding: 20px;">
                <table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px;">
                    <tr>
                        <td>
                            <h1 style="text-align: center; margin-top: 0;">Kantin Online Email Confirmation</h1>
                            <p>Dear ${fullName},</p>
                            ...
                            <p>Thank you,<br>The Kantin Online Developer Team</p>
                        </td>
                    </tr>
                </table>
            </div>
...
const sendResetPasswordLink = ({ email, fullName, resetPasswordToken }) => {
    try {
        ...
        const mailOptions = {
            to: email,
            subject: "Kantin Online Reset Password",
            html: `
            <div style="font-family: Arial, sans-serif; background-color: #f1f1f1; padding: 20px;">
                <table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px;">
                    <tr>
                        <td>
                            <h1 style="text-align: center; margin-top: 0;">Kantin Online Reset Password</h1>
                            <p>Dear ${fullName},</p>
                            <p>We received a request to reset your password for your Kantin Online account. To proceed with the password reset process, please click the link below.</p>
                            <table cellpadding="0" cellspacing="0" border="0" align="center" style="margin-top: 20px;">
                                <tr>
                                    <td style="border-radius: 3px; background-color: #007bff; text-align: center;">
...
const sendRegisterTenantEmail = ({ email, fullName, password }) => {
    try {
        const mailOptions = {
            to: email,
            subject: "Kantin Online Register Tenant",
            html: `
            <div style="font-family: Arial, sans-serif; background-color: #f1f1f1; padding: 20px;">
                <table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px;">
                    <tr>
                        <td>
                            <h1 style="text-align: center; margin-top: 0;">Kantin Online Register Tenant</h1>
                            <p>Dear Tenant "${fullName}", thank you for joining Kantin Online</p>
